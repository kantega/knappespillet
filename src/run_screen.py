...
def draw_image_to_screen(screen, img_path, screen_width, screen_height):
    # Load the image
...
def run(game, debug):
    ...
    while running:
        ...
        img_path = game.get_image()
        t4 = perf_counter()
        pixels.show()
        draw_image_to_screen(screen, img_path, screen_width, screen_height)
        t5 = perf_counter()
